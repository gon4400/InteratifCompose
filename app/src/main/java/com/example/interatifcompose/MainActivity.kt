package com.example.interatifcompose
...
import com.example.interatifcompose.ui.theme.InteratifComposeTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            InteratifComposeTheme {
...
fun Body() {
    ...
    var compoteIndex by remember { mutableStateOf(0) }
